...
- **Modifications**: We extracted the essential ONNX inference and decoding scripts to `inference/vendor/HubertFA/` to streamline the project structure.
...
- **Modifications**: Extracted the core alignment logic and dictionaries to `inference/vendor/LyricFA/`.

### 4. [FunASR](https://github.com/modelscope/FunASR)
Used via its API for the initial transcription (Speech-to-Text) of the vocal audio, providing the foundational text for the alignment process.
- **License**: MIT License
